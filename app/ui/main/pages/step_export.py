...
from app.ui.main.pages.step_base import StepPage, ContentCard
from app.ui.theme.ds_tokens import Colors, FontSizes, FontWeights, Radii
...
class ExportProgress(QFrame):
    ...
    def _setup_ui(self):
        ...
        self._file_label = QLabel("输出: ~/Voxplore/Exports/video_001.mp4")
...
class StepExportPage(StepPage):
    ...
    def _open_folder(self):
        import os
        os.system("xdg-open ~/Voxplore/Exports 2>/dev/null || open ~/Voxplore/Exports 2>/dev/null")
