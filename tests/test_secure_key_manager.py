...
class TestSecureKeyManager:
    ...
    @patch('scenefab.core.secure_key_manager.platform.system')
    @patch('scenefab.core.secure_key_manager.keyring')
    ...
    @patch('scenefab.core.secure_key_manager.platform.system')
    @patch('scenefab.core.secure_key_manager.keyring')
    @patch('scenefab.core.secure_key_manager.SecureKeyManager._get_master_key')
