...
hero:
  name: SceneFab
  text: 短剧解说，结构化生产
  tagline: 从素材采集到竖屏导出，用统一的标签体系、脚本规范和质量门禁驱动每一集产出。
  actions:
    - theme: brand
      text: 快速开始
...
features:
  - icon: 文
    title: 第一人称脚本
    details: 以"我"的视角组织动机、冲突和转折，用结构化模板避免只复述画面。
  - icon: 标
    title: 内容标签体系
    details: 题材、爽点、人物关系、集数上下文和下集钩子全部结构化记录。
  - icon: 声
    title: 配音字幕一体化
    details: 以配音时长和字幕安全区倒推脚本文字量，减少后期返工。
  - icon: 屏
    title: 竖屏交付
    details: 默认 1080x1920 画布，兼顾抖音、TikTok、Shorts 和小红书竖屏规格。
  - icon: 质
    title: 质量门禁
    details: Hook、桥段、字数、字幕同步和发布参数都有可执行的验收点。
  - icon: 架
    title: 工程化流程
...
<section class="sf-section">
  <div class="sf-section-head">
    ...
    <p class="sf-section-copy">创作者、配置负责人和架构审阅者各有对应入口，无需通读全部内容。</p>
  </div>
