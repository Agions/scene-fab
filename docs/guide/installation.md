---
title: 完整安装指南
description: 在 Windows macOS Linux 上完整安装 Voxplore 的详细步骤。
---
...
1. 从 [GitHub Releases](https://github.com/Agions/Voxplore/releases) 下载 `.exe` 安装包
2. 运行安装程序
3. 安装完成后，在开始菜单找到 **Voxplore** 并启动
...
```bash
pip uninstall voxplore
# 或 Homebrew:
brew uninstall voxplore
```
