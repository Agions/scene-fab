...
def _check_update_async(window):
    ...
    try:
        from voxplore.update import check_update, format_update_message
...
def main():
    """主函数"""
    from voxplore.utils.version import __version__
...
def run_monologue():
    ...
    from voxplore.services.video import MonologueMaker, MonologueStyle
...
def run_export():
    ...
    from voxplore.services.export import (
...
def launch_new_ui():
    """启动全新设计的 UI"""
    from voxplore.ui.windows.main_window import MainWindow
    from voxplore.ui.theme.theme_manager import ThemeManager
    from PySide6.QtWidgets import QApplication
    import sys
