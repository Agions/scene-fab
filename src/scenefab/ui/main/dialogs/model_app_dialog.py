...
class ModelApplicationDialog(QWizard):
    ...
    def _create_pages(self):
        """创建页面"""
        providers = self._define_providers()
    ...
    def _define_providers(self):
        """定义提供商列表"""
        return [
            self._baidu_provider(),
            self._spark_provider(),
            self._qwen_provider(),
            self._glm_provider(),
            self._baichuan_provider(),
            self._moonshot_provider(),
        ]
