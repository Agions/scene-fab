...
GITHUB_API_RELEASES = "https://api.github.com/repos/Agions/scene-fab/releases/latest"
GITHUB_RELEASES_PAGE = "https://github.com/Agions/scene-fab/releases"

# HTTP 客户端配置（10s 超时，防止阻塞启动）
_client_config = {
    "timeout": httpx.Timeout(10.0, connect=5.0),
    "headers": {"Accept": "application/vnd.github.v3+json", "User-Agent": "SceneFab"},
}
...
def format_update_message(info: UpdateInfo) -> str:
    """格式化更新提示消息"""
    return (
        f"发现新版本 SceneFab {info.latest_version}！\n\n"
