...
class ShortcutManager(QObject):
    ...
    DEFAULT_SHORTCUTS: list[ShortcutInfo] = [
        # 文件操作
        ShortcutInfo(
            "new_project", "新建项目", ShortcutCategory.FILE, "Ctrl+N", "创建新项目"
        ),
        ShortcutInfo(
            "open_project", "打开项目", ShortcutCategory.FILE, "Ctrl+O", "打开已有项目"
        ),
        ShortcutInfo(
            "save_project", "保存项目", ShortcutCategory.FILE, "Ctrl+S", "保存当前项目"
        ),
        ShortcutInfo(
            "save_as", "另存为", ShortcutCategory.FILE, "Ctrl+Shift+S", "另存为"
        ),
        ShortcutInfo(
            "export", "导出视频", ShortcutCategory.FILE, "Ctrl+E", "导出当前项目"
        ),
        ...
        ShortcutInfo(
            "paste", "粘贴", ShortcutCategory.EDIT, "Ctrl+V", "粘贴复制的片段"
        ),
        ShortcutInfo(
            "delete", "删除", ShortcutCategory.EDIT, "Delete", "删除选中的片段"
        ),
        ShortcutInfo(
            "select_all", "全选", ShortcutCategory.EDIT, "Ctrl+A", "选中所有片段"
        ),
        # 视图操作
        ShortcutInfo(
            "toggle_sidebar",
        ...
        # 播放操作
        ShortcutInfo(
            "play_pause", "播放/暂停", ShortcutCategory.PLAYBACK, "Space", "播放或暂停"
        ),
        ShortcutInfo("stop", "停止", ShortcutCategory.PLAYBACK, "Escape", "停止播放"),
        ShortcutInfo(
            "frame_forward", "下一帧", ShortcutCategory.PLAYBACK, "Right", "前进一帧"
        ),
        ShortcutInfo(
            "frame_backward", "上一帧", ShortcutCategory.PLAYBACK, "Left", "后退一帧"
        ),
        ShortcutInfo(
            "go_to_start",
            "跳转到开始",
        ...
        ShortcutInfo(
            "set_in_point", "设置入点", ShortcutCategory.PLAYBACK, "I", "设置入点"
        ),
        ShortcutInfo(
            "set_out_point", "设置出点", ShortcutCategory.PLAYBACK, "O", "设置出点"
        ),
        # 导出操作
        ShortcutInfo(
            "quick_export",
        ...
        # AI 功能
        ShortcutInfo(
            "ai_analyze", "AI 分析", ShortcutCategory.AI, "Ctrl+Shift+A", "分析当前视频"
        ),
        ShortcutInfo(
            "ai_clip", "AI 剪辑", ShortcutCategory.AI, "Ctrl+Shift+C", "智能剪辑"
        ),
        ShortcutInfo(
            "ai_subtitle", "AI 字幕", ShortcutCategory.AI, "Ctrl+Shift+S", "生成字幕"
        ),
        ShortcutInfo(
            "ai_voice", "AI 配音", ShortcutCategory.AI, "Ctrl+Shift+V", "生成配音"
        ),
        ShortcutInfo(
            "ai_dub", "AI 翻译", ShortcutCategory.AI, "Ctrl+Shift+T", "翻译配音"
        ),
    ]
    ...
    def _register_q_shortcut(self, shortcut: ShortcutInfo) -> None:
        ...
        try:
            ...
            q_shortcut.activated.connect(lambda: self._handle_shortcut(shortcut.id))
    ...
    def export_config(self) -> dict[str, Any]:
        """导出配置"""
        return {
            shortcut_id: {"sequence": shortcut.sequence, "enabled": shortcut.enabled}
