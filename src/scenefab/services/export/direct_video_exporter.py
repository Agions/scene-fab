...
将 SceneFab 项目直接导出为视频文件，支持多种分辨率和格式。
...
使用示例:
    from scenefab.services.export import DirectVideoExporter, VideoExportConfig, Resolution
...
class DirectVideoExporter:
    ...
    def _add_subtitles(
        ...
        # 生成 SRT 字幕文件
        tmpdir = Path(tempfile.mkdtemp(prefix="scenefab_subtitles_"))
        try:
